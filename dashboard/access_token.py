...
def lipa_na_mpesa(data):
	...
	b = Pet_services.objects.get(id=data.get('id'))
	...
	request = {
            ...
            "CallBackURL": "https://1fdee32e.ngrok.io/process_lnms/",
            "AccountReference": "Rafiki Pet store",
            "TransactionDesc": "Rafiki Pet store",
        }
